package com.br.edercnj.walletuser.configuration;
...
public class SwaggerConfig {
    ...
    public Docket apiDocumentationPackage() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.br.edercnj.walletuser.web.api.v1"))
                .build()
